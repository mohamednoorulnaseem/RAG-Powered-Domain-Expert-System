...
from config import get_settings, SYSTEM_PROMPT, QUERY_PROMPT_TEMPLATE, SUMMARY_PROMPT_TEMPLATE
...
class QueryEngine:
    ...
    def _generate_answer(self, query: str, context: str, session_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    def query(self, 
              ...
              hybrid_weight: float = 0.5) -> QueryResponse:
        """
        ...
        logger.success(f"Query completed in {total_time:.0f}ms with {len(citations)} citations")
        return response
