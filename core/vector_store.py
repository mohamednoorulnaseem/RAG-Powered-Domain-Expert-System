...
from core.embeddings import get_embedding_service, BaseEmbeddingService, cosine_similarity
...
class VectorStore:
    ...
    def __init__(self, 
        ...
        self.persist_path = persist_path or str(self.settings.data_dir / "vector_store.json")  # Changed to JSON
        
        # Initialize embedding service
        self.embedding_service = embedding_service or get_embedding_service(use_openai=True)
    ...
    def _save(self):
        ...
        try:
            ...
            print(f"DEBUG: Saved {len(self.entries)} entries to {self.persist_path}") # Console visible
    ...
    def search(self, 
               ...
               hybrid_weight: float = 0.5) -> SearchResults:
        """
        ...
        if self.bm25 and hybrid_weight < 1.0:
            ...
            for i, entry in enumerate(self.entries):
                ...
                combined_score = (v_score * hybrid_weight) + (k_score * (1.0 - hybrid_weight))
