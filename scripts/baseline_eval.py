"""
RAG Expert System - Baseline Evaluation
Evaluates the current RAG pipeline using Ragas metrics on 20 QA pairs.
"""
...
def run_evaluation():
    ...
    # Clear and re-ingest sample contract to ensure clean baseline database
    vector_store.clear()
    ...
    output_file = metrics_dir / "baseline.json"
    with open(output_file, "w", encoding="utf-8") as f:
        json.dump(results_data, f, indent=2)
        
    # Print clean results table
    print("\n" + "=" * 70)
    print("📈 EVALUATION RESULTS TABLE (BASELINE)")
    print("=" * 70)
