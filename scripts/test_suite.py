...
def test_configuration():
    ...
    assert settings.api_port == 8001, f"API port should be 8001, got {settings.api_port}"
    ...
    assert 0 <= settings.similarity_threshold <= 1, "Similarity threshold must be between 0 and 1"
...
def test_vector_store():
    ...
    assert vector_store.embedding_service is not None, "Embedding service should be initialized"
